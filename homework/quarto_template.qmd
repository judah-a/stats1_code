...
csl: data/american-journal-of-sociology.csl
---
...
Quarto allows for [easy cross-references of images and plots](https://quarto.org/docs/authoring/cross-references.html#figures). @fig-dead shows an image, whereas @fig-plot shows a plot created using ggplot2.

![This is a picture of the Grateful Dead at Mickey's (I think) ranch. This is my background photo.](images/Grateful-Dead-1970-photo-credit-Warner-Bros-Records-Herb-Greene.png){#fig-dead fig-align="center"}
...
It's also easy to cross-reference equations. For example, @eq-1 depicts Freeman's *Degree Centralization Measure.*

$$
C_D = \frac{\sum_{i=1}^n [C_D(p^*)-C_D(p_i)]}{n^2-3n+2}
$$ {#eq-1}
...
> Hi! My name is Judah. One of my favorite academic books is Abbott's *Time Matters* [@abbott2001]. Ragin's *Redesigning Social Inquiry: Fuzzy Sets and Beyond* [@ragin2008] is the last thing I read. The next thing I plan on reading is Skocpol's *States and Social Revolutions* [@skocpol1979].
